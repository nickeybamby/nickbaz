...
const socialLinks = [
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/nickeybamby",
    icon: (
  ...
  {
    name: "GitHub",
    href: "https://github.com/nickeybamby",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-bold text-xl">Nicholas Obazei</span>
            </div>
            <p className="text-muted-foreground mb-4">
              Technical Project Manager & Frontend Developer helping teams deliver exceptional digital experiences.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <Button key={social.name} asChild variant="ghost" size="sm" className="p-2">
